...
NeighboorCheck=zeros(2*Connecting_Distance+1);

Dummy=2*Connecting_Distance+2;
Mid=Connecting_Distance+1;
%%%%%%%%%%%%%%%%%%%%%%%%%
%NeighboorCheck(Mid,Mid)=0;
NeighboorCheck(Mid,Mid+Connecting_Distance)=1;
NeighboorCheck(Mid,Mid-Connecting_Distance)=1;
NeighboorCheck(Mid+Connecting_Distance,Mid)=1;
NeighboorCheck(Mid-Connecting_Distance,Mid)=1;
%%%%%%%%%%%%%%%%%%%%%%%%%
